...
const PropertyDetails = () => {
  ...
  const handleAddToWishlist = () => {
    ...
    axiosSecure.post("/wishlist", newProduct).then((res) => {
    ...
    <div>
      ...
      <div className="container mx-auto px-5 my-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <div
            ...
            className="flex flex-col lg:flex-row rounded-xl shadow-xl lg:col-span-2"
          >
              ...
              <div className="px-5 pb-8">
                ...
                <div className="flex gap-5">
                  <button
                    ...
                    className="btn bg-[#03a9fc] border-[#03a9fc] hover:bg-white hover:text-[#03a9fc] text-white hover:border-[#03a9fc] mt-5"
                  >
                    Add To Wishlist
                  </button>
                    ...
                    <form onSubmit={handleAddReview}>
                      ...
                      <div>
                        ...
                        <div
                          data-aos="fade-up"
                          data-aos-duration="3000"
                          className="flex flex-col md:flex-row border border-[#03a9fc] rounded-xl mt-5"
                        >
                      ...
                      <div className="flex justify-center my-5">
                        <div className="w-full">
                          <button className="btn w-full bg-[#03a9fc] border-[#03a9fc] hover:bg-white hover:text-[#03a9fc] text-white hover:border-[#03a9fc]">
                            Add Review
                          </button>
                        </div>
                      </div>
            ...
            <div className="shadow-xl rounded-xl py-10 px-5 ">
              ...
              <div>
                <h2 className="text-2xl text-center uppercase font-bold">
                  <span className="text-lg">Agent:</span> <br /> {agentName}
                </h2>
      ...
      <div className="container mx-auto px-5">
        <h2
          data-aos="fade-up"
          data-aos-duration="3000"
          className="text-3xl font-bold text-center mt-14 mb-7"
        >
          {propertyTitle} <br /> All Reviews
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10 mb-10">
          {review.map((review) => (
            <div
              key={review._id}
              className="border-4 border-[#03a9fc] p-7 rounded-xl "
            >
