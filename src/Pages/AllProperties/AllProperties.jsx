...
const AllProperties = () => {
  ...
  useEffect(() => {
    const results = verifiedProperties.filter(
      (property) =>
        property.propertyTitle
          .toLowerCase()
          .includes(searchTerm.toLowerCase()) &&
        (minPrice === "" ||
          parseFloat(property.minPriceRange) >= parseFloat(minPrice)) &&
        (maxPrice === "" ||
          parseFloat(property.maxPriceRange) <= parseFloat(maxPrice))
    );
    if (minPrice && maxPrice) {
      results.sort(
        (a, b) => parseFloat(a.minPriceRange) - parseFloat(b.minPriceRange)
      );
    }
                  ...
                  <div>
                    ...
                    >
                      <h1 className="mb-5 text-3xl lg:text-6xl font-bold text-white text-center">
                        ALL <span className="text-[#03a9fc]"> PROPERTIES</span>
                      </h1>
                    </motion.div>
                    <motion.div
                      initial={{ opacity: 0, x: -20 }}
                    ...
                    >
                      <p className="text-white w-2/3 text-center">
                        ...
                        extraordinary. Your dream home awaits in our portfolio
                        of luxurious real estate.
                      </p>
                    </motion.div>
                  </div>
                  ...
                  <div data-aos="fade-right" data-aos-duration="3000">
                    <div className="flex justify-start lg:justify-center  my-10 md:ml-0">
                      <div className="relative w-full lg:w-1/2">
                        ...
                        />
                        <button className="btn bg-[#03a9fc] border-[#03a9fc] hover:bg-white hover:text-[#03a9fc] text-white absolute right-0  hover:border-[#03a9fc]">
                          Search
                        </button>
                      </div>
                    </div>
      ...
      <div className="container mx-auto px-5 mb-20">
        <div className="flex justify-center my-10">
          ...
          >
            ...
            <button className="btn bg-[#03a9fc] border-[#03a9fc] hover:bg-white hover:text-[#03a9fc] text-white  hover:border-[#03a9fc]">
              Sort
            </button>
          </form>
        </div>
