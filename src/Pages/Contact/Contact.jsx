...
const Contact = () => {
  return (
    <div>
      <Helmet>
        <meta charSet="utf-8" />
        <title>ApnaGhar | Contact Us</title>
      </Helmet>
      ...
      <div className="container mx-auto px-5 pt-5 py-20 mt-10">
        <div className="flex flex-col lg:flex-row gap-20">
          <div className="flex-1">
            <div>
              ...
              <h1 className="mb-5 text-3xl lg:text-5xl font-bold">
                New York <span className="text-[#03a9fc]">Office</span>
              </h1>
              <p className="mb-5">
          ...
          >
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d273750.5722171378!2d-73.90903932201854!3d40.70601539022244!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY%2C%20USA!5e0!3m2!1sen!2sbd!4v1700820472436!5m2!1sen!2sbd"
            ></iframe>
          </motion.div>
        </div>
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-20">
          ...
          >
            <iframe
              className="w-full h-full"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6502595.146296284!2d-119.306607!3d37.2691675!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x808fb9fe5f285e3d%3A0x8b5109a227086f55!2sCalifornia%2C%20USA!5e0!3m2!1sen!2sbd!4v1700821561816!5m2!1sen!2sbd"
            ></iframe>
          </motion.div>
          ...
          <div className="flex-1">
            <div>
              ...
              <h1 className="mb-5 text-3xl lg:text-5xl font-bold">
                California <span className="text-[#03a9fc]">Office</span>
              </h1>
              <p className="mb-5">
                Morbi mollis elit vitae elit molestie lobortis. Cras eu purus
                ipsum. Aliquam et ullamcorper nisl. Nam sem justo, sagittis sit
        ...
        <div className="px-20 pb-20">
          <div>
            ...
            <h1 className="mb-5 text-3xl lg:text-5xl font-bold text-center">
              Drop us a <span className="text-[#03a9fc]">line below</span>
            </h1>
            <div className="flex justify-center">
              <p className="mb-8 text-center w-1/2">
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="flex-1 border rounded-xl p-14">
              <h2 className="text-2xl font-bold mb-4 text-[#03a9fc]">
                Feedback From
              </h2>
              ...
              <button className="btn w-full bg-[#03a9fc] border-[#03a9fc] text-white hover:bg-white hover:text-[#03a9fc] hover:border-[#03a9fc] px-14">
                Submit
              </button>
            </div>
