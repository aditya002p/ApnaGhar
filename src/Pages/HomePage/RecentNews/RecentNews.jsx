        ...
        <div>
          ...
          >
            <h1 className="mb-5 text-3xl lg:text-6xl font-bold text-center">
              LATEST <span className="text-[#03a9fc]">NEWS</span>
            </h1>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 20 }}
          ...
          >
            ...
            <div>
              ...
              <div className="px-8 pb-8">
                ...
                <p>
                  Ea cibo choro eos, in duo iudico eirmod. Qui modus meliore ex,
                  has in decore virtute repudiare. An summo persequeris
                  contentiones nec, ex sit modus
                </p>

                <button className="btn mt-5 bg-[#03a9fc] border-[#03a9fc] text-white hover:bg-white hover:text-[#03a9fc] hover:border-[#03a9fc]">
                  Read More
                </button>
              </div>
            </div>
