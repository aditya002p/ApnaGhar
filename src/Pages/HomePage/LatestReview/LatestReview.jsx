  ...
  return (
    <div className="container mx-auto px-5 my-28">
      <div className="my-14">
        ...
        >
          <h1 className="mb-5 text-3xl lg:text-6xl font-bold text-center">
            WHAT OUR <span className="text-[#03a9fc]">CLIENTS SAY</span>
          </h1>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, x: 20 }}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {sortedReviews.slice(0, 3).map((card) => (
          <div
            key={card._id}
            className="border p-7 rounded-xl border-[#03a9fc]"
          >
            <div>
            ...
            <div className="flex gap-3 mb-4">
              {card.userImage ? (
                ...
                <FaUserCircle className="text-[52px]"></FaUserCircle>
              )}
            ...
            <h2 className="text-3xl font-bold text-[#03a9fc]">
              {card.property.propertyTitle}
            </h2>
