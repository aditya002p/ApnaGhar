        ...
        fetch(`https://evergreen-estate-server.vercel.app/wishlist/${_id}`, {
          ...
          .then((data) => {
            ...
            if (data.deletedCount > 0) {
              ...
              const remaining = myWishlist.filter(
        ...
        <div>
          ...
          <div className="my-5 flex gap-5 w-full px-5 pb-5">
            <Link to={`/dashboard/makeOffer/${_id}`}>
              <button className="btn px-7 bg-[#03a9fc] border-[#03a9fc] hover:bg-white hover:text-[#03a9fc] text-white hover:border-[#03a9fc]">
                Make An Offer
              </button>
            </Link>
            ...
            <button
              ...
              className="btn flex-1 bg-red-500 border-red-500 hover:bg-white hover:text-red-500 text-white hover:border-red-500"
            >
              Remove
            </button>
          </div>
