  ...
  const handleAddProperty = (event) => {
    ...
    if (
      parseFloat(offeredAmount) <
        parseFloat(makeOffer.property.minPriceRange) ||
      parseFloat(offeredAmount) > parseFloat(makeOffer.property.maxPriceRange)
    ) {
      Swal.fire({
        position: "center",
        icon: "error",
      ...
      <div className="container mx-auto px-5 mb-20">
        <div className="flex justify-center">
          <form
            ...
            className="w-full lg:w-2/3 shadow-2xl p-10 pb-14 rounded-xl"
          >
            {/* Property Information */}
            <h2 className="text-xl font-bold pb-1 uppercase">
              Property INFORMATION
            </h2>
            <div>
              ...
              <div className="w-full">
                <div className="form-control">
                  ...
                  <input
                    ...
                    type="text"
                    name="propertyTitle"
                    defaultValue={makeOffer.property.propertyTitle}
                ...
                <div className="w-full">
                  <div className="form-control">
                    ...
                    <input
                      ...
                      type="text"
                      name="propertyImage"
                      defaultValue={makeOffer.property.propertyImage}
                      className="input input-bordered"
                      required
                    />
                  </div>
                ...
                <div className="form-control">
                  ...
                  <input
                    ...
                    type="text"
                    name="agentName"
                    defaultValue={makeOffer.property.agentName}
                    className="input input-bordered"
                    required
                  />
                </div>
              ...
              <div className="w-full">
                <div className="form-control">
                  ...
                  <input
                    ...
                    type="text"
                    name="location"
                    defaultValue={makeOffer.property.location}
                    className="input input-bordered"
                    required
                  />
                </div>
                ...
                <div className="form-control w-full">
                  ...
                  <input
                    ...
                    type="email"
                    name="agentEmail"
                    defaultValue={makeOffer.property.email}
                    className="input input-bordered"
                    required
                  />
                </div>
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text">
                  ...
                  <span className="text-[#03a9fc]">
                    (
                    {`$${makeOffer.property.minPriceRange}-$${makeOffer.property.maxPriceRange}`}
                    )
                  </span>
                </span>
              </label>
              <input
                type="text"
                name="offeredAmount"
                placeholder="Enter You offered Amount"
                className="input input-bordered"
                required
              />
            </div>
            ...
            <div>
              <button className="btn bg-[#03a9fc] border-[#03a9fc] hover:bg-white hover:text-[#03a9fc] text-white font-bold w-full mt-8">
                Send Offer
              </button>
            </div>
          </form>
