...
const AddedProperties = () => {
  ...
  const addedProperty = properties.filter(
              ...
              >
                <div className="md:h-[150px]">
                  ...
                  <div className="flex gap-2 text-lg">
                    ...
                    <p>
                      ...
                      {`$${property.minPriceRange}-$${property.maxPriceRange}`}
                    </p>
                  </div>
                  <div className="flex gap-2 text-lg">
                    <div className="flex items-center text-[#03a9fc]">
                    ...
                    <p>
                      ...
                      {property.status === "Pending" && (
                        <span className="text-warning"> {property.status}</span>
                      )}
                      ...
                      {property.status === "Rejected" && (
                        <span className="text-red-600"> {property.status}</span>
                      )}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-5 mt-4">
                  {property.status === "Rejected" && (
                    <button
                      disabled
                      className="btn px-8 flex-1 bg-[#03a9fc] border-[#03a9fc] hover:bg-white hover:text-[#03a9fc] text-white hover:border-[#03a9fc]"
                    >
                      Update
                    </button>
                  )}
                  ...
                  <button
                    ...
                    className="btn flex-1 px-8 bg-red-500 border-red-500 hover:bg-white hover:text-red-500 text-white hover:border-red-500"
                  >
                    Delete
                  </button>
                </div>
