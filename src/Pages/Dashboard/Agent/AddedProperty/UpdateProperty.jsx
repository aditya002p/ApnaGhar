      ...
      <div className="container mx-auto px-5 mb-20">
        <div className="flex justify-center">
          <form
            ...
            className="w-full lg:w-2/3 border p-10 pb-14 rounded-xl"
          >
                ...
                <div className="flex gap-5">
                  <div className="form-control">
                    ...
                    <input
                      type="number"
                      name="minPriceRange"
                      defaultValue={property.minPriceRange}
                      className="input input-bordered"
                      required
                    />
                  </div>
                  <div className="form-control">
                    ...
                    <input
                      type="number"
                      name="maxPriceRange"
                      defaultValue={property.maxPriceRange}
                      className="input input-bordered"
                      required
                    />
                  </div>
            ...
            <div className="w-full">
              <div className="form-control">
                ...
                <input
                  type="text"
                  name="agentImage"
                  defaultValue={property.agentImage}
                  className="input input-bordered"
                />
              </div>
            </div>
