    ...
    <>
        ...
        <>
          <li className="text-xl">
            <NavLink to="/dashboard/manageProperties">
              <MdRealEstateAgent></MdRealEstateAgent> Manage Properties
            </NavLink>
          </li>
          <li className="text-xl">
        ...
        <>
          ...
          <li className="text-xl">
            <NavLink to="/dashboard/addProperties">
              <IoIosAddCircle></IoIosAddCircle>Add Properties
            </NavLink>
          </li>
          <li className="text-xl">
            <NavLink to="/dashboard/addedProperties">
              <MdBookmarkAdded></MdBookmarkAdded>Added Properties
            </NavLink>
          </li>
          <li className="text-xl">
            <NavLink to="/dashboard/soldProperties">
              <BiSolidAnalyse></BiSolidAnalyse>Sold Properties
            </NavLink>
          </li>
          <li className="text-xl">
        ...
        <>
          ...
          <li className="text-xl">
            <NavLink to="/dashboard/wishlist">
              <FaCartPlus></FaCartPlus> Wishlist
            </NavLink>
          </li>
          <li className="text-xl">
            <NavLink to="/dashboard/propertyBought">
              <RiMenuSearchFill></RiMenuSearchFill> Property Bought
            </NavLink>
          </li>
          <li className="text-xl">
      ...
      <li className="text-xl">
        <NavLink to="/allProperties">
          <MdOutlineMenu></MdOutlineMenu>All Properties
        </NavLink>
      </li>
    </>
  );
